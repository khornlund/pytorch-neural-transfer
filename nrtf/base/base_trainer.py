...
import torch
import yaml
from nrtf.utils.util import ensure_dir
from nrtf.utils.visualization import WriterTensorboardX
from nrtf.utils.logger import setup_logger
...
class BaseTrainer:
    ...
    def __init__(self, model, loss, metrics, optimizer, resume, config):
        self.config = config
        self.logger = self.logger = setup_logger(self, verbose=config['trainer']['verbose'])
